package ru.netology.tetrisnoactivity.views
...
import ru.netology.tetrisnoactivity.GameActivity
import ru.netology.tetrisnoactivity.constants.CellConstants
import ru.netology.tetrisnoactivity.constants.FieldConstants
import ru.netology.tetrisnoactivity.models.AppModel
import ru.netology.tetrisnoactivity.models.Block

class TetrisView : View {
    private val paint = Paint() //Рисование текста
    private var lastMove: Long = 0 //Отслеживание промежутка времени в миллисекундах
    private var model: AppModel? = null //Хранение AppModel
    private var activity: GameActivity? = null
    private val viewHandler = ViewHandler(this)
    private var cellSize: Dimension = Dimension(0, 0) //Размер ячеек в игре
    private var frameOffset: Dimension = Dimension(0, 0) //Смещение фрейма
    ...
    //Устанавливает исполняему игрой текущую команду перемещения
    ...
    //Обновляет счет игры и переводит viewHandler в спящий режим
